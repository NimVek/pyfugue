...
class LogHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        self.__target.append(urwid.Text((urwid.AttrSpec(color, "default"), msg)))


class LogObserver:
    color = {
        twisted.logger.LogLevel.critical: "light red",
    ...
    def __call__(self, event):
        ...
        self.__target.append(urwid.Text((urwid.AttrSpec(color, "default"), f"% {msg}")))
...
class Log(urwid.WidgetWrap):
    ...
    def cleanup(self, loop, user_data=None):
        ...
        self.log.contents = [x for x in self._w.contents if x[0].timestamp > threshold]
